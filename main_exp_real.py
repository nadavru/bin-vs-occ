...
datasets = ["arrhythmia", "breastw", "pima", "satellite", "satimage-2", "speech", "vertebral"]
...
for dataset in datasets:
    ...
    outliers_length = out_dataset.shape[0]
    total_rows = inliers_length + outliers_length
    outliers_ratio = outliers_length/total_rows
    ...
    result_folder = f"{results_folder}/{dataset}"
    ...
    plt.subplot(1,2,2)
    axs[1].axis("square")
    sn.heatmap(cov_out_dataset, annot=False, fmt='g', vmin=-1, vmax=1, cbar=False, yticklabels=False)
